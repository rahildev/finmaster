...
export default function Footer({ contacts }: FooterProps) {
  ...
  const socialContacts = contacts.filter(c => ['instagram', 'linkedin', 'youtube', 'tiktok', 'facebook'].includes(c.type));
          ...
          <div>
            ...
            <ul className="hover-color space-y-2.5">
              ...
              <li className="flex items-center gap-2 text-sm text-gray-600">
                ...
                <span className="font-inter">{language === 'en' ? 'Baku, Azerbaijan' : 'Bakı, Azərbaycan'}</span>
              </li>
            </ul>
          </div>
                ...
                ? socialContacts.map(c => (
                  ...
                  >
                    ...
                    <span className="font-inter capitalize">
                      {c.type === 'youtube' ? 'YouTube' : c.type === 'tiktok' ? 'TikTok' : c.type === 'facebook' ? 'Facebook' : c.type.charAt(0).toUpperCase() + c.type.slice(1)}
                    </span>
                  </a>
                ))
